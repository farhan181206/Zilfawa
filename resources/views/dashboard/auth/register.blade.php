        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form action="{{route('register-process')}}" id="formAuthentication" class="mb-3" method="POST">
                @csrf
                @method('POST')
                <div class="mb-3">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" id="phone" name="phone" placeholder="Enter your Number Phone" />
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" id="age" name="age" placeholder="Enter your age" min="0" />
                </div>
                <div class="mb-3">
                    ...
                    <select name="gender" id="gender" class="form-select">
                        ...
                        <option value="No">Tidak Mau Di Ketahui</option>
                    </select>
                </div>
